...
import LordVLogo from '../assets/Lordv_Logo.jpg';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            >
              <div className="flex items-center space-x-3 mb-4">
                <img 
                  src={LordVLogo} 
                  alt="LordV Tourism Logo" 
                  className="h-8 w-auto"
                />
                <span className="text-xl font-bold">LordV Tourism</span>
              </div>
              <p className="text-primary-300 mb-4 max-w-md">
                ...
                we bring you unforgettable journeys.
              </p>
              <div className="flex space-x-4">
                {socialLinks.map((social) => {
                  const isWhatsApp = social.name === 'WhatsApp';
                  const href = isWhatsApp 
                    ? "https://wa.me/919226551564?text=Hello%20from%20LordV%20Tourism%20website!"
                    : "#";
          ...
          <div>
            ...
            >
              ...
              <div className="space-y-2 text-primary-300">
                <p>📧 support@lordvtourism.com</p>
                <p>📧 hr@lordvtourism.com</p>
                <p>📞 +91 92265 51564</p>
                <p>📞 +91 92265 51568</p>
                <p>📍 60 Feet Rd, opp. Amazon Prime, near Bhairavnath Bharat Gas Agency, Shivneri Colony, Agrasen Nagar Society, Pimple Gurav, Pune, Pimpri-Chinchwad, Maharashtra 411061</p>
                <div className="flex items-center space-x-2 mt-4">
                  <a
                    href="https://wa.me/919226551564?text=Hello%20from%20LordV%20Tourism%20website!"
                    target="_blank"
        ...
        >
          <p className="text-primary-400">
            © {currentYear} LordV Tourism. All rights reserved. | Made with ❤️ in India
          </p>
        </motion.div>
      </div>
    </footer>
